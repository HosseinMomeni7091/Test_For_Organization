              ...
              <form class="space-y-4 md:space-y-6" action="{{route('register')}}" method="Post">
                @csrf
                  ...
                  <div class="flex items-center justify-between">
                      <button type="submit" class="w-1/4 text-black bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register</button>
                    </form>
                  </div>
          </div>
      </div>
